<template>
    <div class="container">
        ...
        <h3 class="fw-bold text-primary my-3">Hafta kunlari</h3>

        <div class="col-12 d-flex justify-content-between my-3">
            <button @click="chengeTabView('Tab32View')" class="btn" style="background-color: hsla(265, 11%, 78%, 0.514); color: hsl(264, 81%, 43%);">
                <i class="fa-solid fa-arrow-left"></i> Oldingisi 
            </button>
            <button @click="chengeTabView('Tab34View')" class="btn text-white" style="background-color: hsla(264, 88%, 55%, 0.711); color: hsl(264, 81%, 43%);">Keyingisi <i class="fa-solid fa-arrow-right"></i></button>
        </div>
            

        <div class="col-6">
            <p class="fw-medium fs-4">Dushanba</p>
            <p class="fw-medium fs-4">Seshanba</p>
            <p class="fw-medium fs-4">Chorshanba</p>
            <p class="fw-medium fs-4">Payshanba</p>
            <p class="fw-medium fs-4">Juma</p>
            <p class="fw-medium fs-4">Shanba</p>
