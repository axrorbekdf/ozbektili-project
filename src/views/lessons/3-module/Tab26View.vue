<template>
    <div class="container">
        ...
        <h3 class="fw-bold text-primary my-3">Qayerda?</h3>
        ...
        <div class="col-12">
            <h3></h3>
            <ol class="fw-medium">
                <li>O&lsquo;tgan mavzu asosida mashq</li>
                <li>Kunning qismlari / mashq</li>
                <li>Fasllar va oylar / mashq</li>
                <li>Hafta kunlari</li>
                <li>Kiyim-kechak nomlari</li>
                <li>Fasllarga mos kiyimlarning sifat belgilari</li>
                <li>Ranglarga mashq</li>
                <li>O&lsquo;qish uchun matn (unda uchrashuv belgilash aks etadi)</li>
            </ol>
        </div>
