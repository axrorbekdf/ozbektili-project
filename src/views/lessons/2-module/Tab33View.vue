        ...
        <div class="row mt-5">
            ...
            <div class="col-12" style="display:flex; align-items:center; justify-content: end;">
                ...
                <div class="alert alert-info px-4 py-1 mx-3" style="border-radius: 0;">
                    ...
                    <p class="m-0 text-start">Bolalar _________kelyaptilar.</p>
                </div> 
            ...
            <div class="col-12" style="display:flex; align-items:center;">
                ...
                <div class="alert alert-info px-4 py-1 mx-3" style="border-radius: 0;">
                    ...
                    <p class="m-0 text-start">Turist _________ kelyapti.</p>
                </div> 
            </div>
            ...
            <div class="col-12" style="display:flex; align-items:center; justify-content: end;">
                ...
                <div class="alert alert-info px-4 py-1 mx-3" style="border-radius: 0;">
                    ...
                    <p class="m-0 text-start">Oilamiz ____________ kelyapti.</p>
                </div> 
