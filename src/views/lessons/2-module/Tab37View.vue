    ...
    <div class="container">
        <div class="row mt-5">
            ...
            <div class="col-12 d-flex justify-content-between my-3">
                <button @click="chengeTabView('Tab36View')" class="btn" style="background-color: hsla(265, 11%, 78%, 0.514); color: hsl(264, 81%, 43%);">
...
export default {
    ...
    data() {        
      return {
        ...
        data:[
            [
                { name: 'televizorni', id: 1 },
                { name: 'sotib olyapti', id: 2 },
                { name: 'Akmal', id: 3 },
                { name: 'supermarketdan', id: 4 },
            ],
            [
                { name: 'davolayapti', id: 1 },
                { name: 'shifokor', id: 2 },
                { name: 'kasalxonada', id: 3 },
                { name: 'bolalarni', id: 4 },
            ],
            [
                { name: 'shahardan', id: 1 },
